...
The player is drawn as a "@" symbol and is moved using aswd keys and the program is ended by inputting the z key.
...
Some hallways may end up with a floor tile and accomplanying walls missing. Unclear why this happens, but may have to to with the while loop in the hallway function.
